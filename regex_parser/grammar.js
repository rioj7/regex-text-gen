...
var grammar = (function () {
    var PRODUCTION_RULES_TXT = [
        ...
        "VALUE_EXPR          : { { = VALUE_EXPRESSION OPT_EXPR_MODS } }",
        "EXPR_CHAR           : ij[]+-*/%()SN",
        "EXPR_CHAR           : DIGIT",
        "EXPR_CHAR           : DOT",
        ...
        "VAL_EXPR_CHAR       : ~:}",
        "VAL_EXPR_CHARS      : VAL_EXPR_CHAR VAL_EXPR_CHARS",
        "VAL_EXPR_CHARS      : ",
        "VALUE_EXPRESSION    : VAL_EXPR_CHAR VAL_EXPR_CHARS",
